...
export const useDashboardStore = defineStore('dashboard', () => {
    ...
    /**
     * 🎯 GETTER: Devuelve solo los primeros 5 funcionarios más productivos.
     */
    const top5FuncionariosCobertura = computed(() => {
        // Asume que 'funcionariosCobertura' ya está ordenado por total de registros (lo cual suele ser el caso para las listas de cobertura).
    ...
    return {
        ...
        top5FuncionariosCobertura, // 👈 Se exporta el getter
        loadDashboardData,
        fetchPrincipalKpis, 
